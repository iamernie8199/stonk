...
CORE_OVERRIDES = {
    # 散熱 & 液冷
    '3017': 'AI 散熱 / 液冷熱管理',
    '3324': 'AI 散熱 / 水冷冷板與 CDU',
    '3653': '均熱板 (Heat Spreader) / 液冷散熱',
    '8996': '熱交換器 / 水冷液冷分配系統 (CDU)',

    # AI 伺服器 & 機櫃代工
    '2059': 'AI 伺服器滑軌 / 機櫃導軌',
    '2317': 'AI 伺服器 / 整機整櫃 (Rack-scale)',
    '2356': 'AI 伺服器 / 整機代工',
    '2376': 'AI 伺服器 / GPU 主機板週期',
    '2382': 'AI 伺服器 / 整機整櫃 (Rack-scale)',
    '3231': 'AI 伺服器主板 / L6-L10 代工',
    '3706': 'AI 伺服器 / 機櫃組裝 / 邊緣運算',
    '6278': 'SMT 打件服務 / 伺服器組裝',
    '6669': 'AI 伺服器 / 液冷整櫃 (Rack-scale)',
    '8210': 'AI 伺服器機殼 / 機櫃',

    # 電源 & 電力
    '1503': '重電設備 / AIDC電力基建',
    '2301': 'AI 伺服器電源 / 電源系統',
    '2308': 'AI 電力基建 / 電源與液冷系統',
    '6415': '電源管理 IC (PMIC) / 伺服器電源',
    '6719': '電源管理 IC / DrMOS',

    # 先進封裝 / 晶圓代工 / 成熟製程
    '1560': '鑽石碟 / 半導體先進製程材料',
    '2303': '晶圓代工 / 成熟與特殊製程',
    '2330': '先進製程 / 先進封裝 (CoWoS)',
    '2449': '晶圓測試 / 先進封測 OSAT 平台',
    '3711': '先進封測 / CoWoS / OSAT 平台',
    '5347': '8吋晶圓代工 / 成熟製程',
    '6147': 'DDIC 驅動 IC 封測 / 金凸塊',
    '6239': '記憶體封測 / 先進封測 OSAT',
    '6257': 'IC 測試 / 高頻 RF 與 AI 測試',
    '6271': 'CIS 影像感測器封裝 / 陶瓷基板',
    '6488': '半導體矽晶圓 / 12吋晶圓材料',
    '6770': '晶圓代工 / 成熟製程 & 3D FAB',

    # AI ASIC / IC 設計
    '2454': '手機 SoC / AI ASIC 晶片平台',
    '3034': '驅動 IC / OLED / 晶片設計',
    '3035': 'ASIC 設計服務 / IP 授權',
    '3443': 'AI ASIC / NRE 與 Turnkey 服務',
    '3529': '嵌入式 IP / 安全加密 IP',
    '3661': '雲端 AI ASIC / 先進封裝設計',
    '5274': 'BMC 遠端管理晶片 / 伺服器 SoC',

    # 網通 & 高速交換器 & 低軌衛星
    '2313': '高階 HDI 板 / 低軌衛星 / 伺服器板',
    '2345': '高速交換器 / 800G / CPO 矽光子',
    '2368': 'AI 伺服器板 / 高層數 PCB',
    '3491': '低軌衛星天線 / 微波毫米波元件',
    '6285': '網通設備 / 車用通訊 / 低軌衛星',

    # 材料 & 載板 & CCL
    '1303': '塑化與電子材料平台',
    '2383': '高階 CCL / Low CTE 玻纖布',
    '3037': 'ABF 載板 / 先進基板',
    '3189': 'ABF 載板 / BT 載板',
    '3715': '高階汽車板 / 伺服器 PCB',
    '4958': 'PCB 全系列平台 / 載板',
    '5483': '矽晶圓 / 綠能與半導體材料',
    '6213': '高階 CCL 銅箔基板 / 網通板',
    '6274': '高階 CCL / 極低損耗銅箔基板',
    '6548': '半導體導線架 / 封裝材料',
    '8046': 'ABF 載板 / BT 載板',
    '8358': '高頻高速電子銅箔',

    # 記憶體
    '2344': 'DRAM 記憶體 / NOR Flash',
    '2408': 'DRAM 記憶體 / 記憶體循環',
    '3260': '記憶體模組 / DRAM & NAND',
    '8150': '記憶體封測 / 驅動 IC 封測',
    '8299': 'NAND 控制 IC / aiDRAM / 儲存',
    ...
    # 高速介面
    '2379': '乙太網 IC / 網通晶片 / 高速介面',
    '4966': '高速介面 / Retimer & Redriver',
    '5269': '高速傳輸介面 / USB4 / PCIe',

    # III-V 光電 & RF
    '2455': 'III-V 磊晶 / RF 前端 / 光電子',
    '3081': 'CPO 矽光子 / 磷化銦 CW Laser',
    '3105': 'III-V 砷化鎵代工 / PA / VCSEL',

    # 設備 & 測試介面
    '2360': '量測儀器 / 半導體與電力測試設備',
    '2467': '先進封裝壓膜與烘烤設備',
    '3131': '先進封裝濕製程設備 / 化學品',
    '3264': '半導體測試 / 車用與工控封測',
    '3563': 'AOI 光學檢測設備 / PCB 檢測',
    '6187': 'CoWoS 先進封裝自動化設備',
    '6223': '探針卡 / 測試板 / 測試介面',
    '6510': '高階探針卡 / 測試板',
    '6515': '測試座 (Socket) / 探針卡',
    '7769': 'FT & SLT 測試分選機 (Handler)',
    '7795': 'PCB & 載板真空壓膜設備',
    ...
    '2492': 'MLCC / 被動元件',
    '3008': '高階光學鏡頭 / 潛望式鏡頭',
    '3023': '客製化線束 / 綠能與 AIDC 連接器',
    '3026': '高壓 MLCC / 被動元件',
    '3533': 'CPU Socket 插槽 / 高速連接器',
    '3605': '高速傳輸線材 / 電子連接器',
    '3665': 'AI 伺服器高階線束 / 客製化連接線',
    '6173': '大尺寸 MLCC / 被動元件材料',
    '6805': '軸承 (Hinge) / 水冷快接頭元件',
...
CORE_BUCKETS = [
    ('all-core', '全部主線'),
    ('core-cooling', 'AI散熱 / 液冷'),
    ('core-ai-server', 'AI伺服器 / GPU'),
    ('core-packaging', '先進封裝 / 封測'),
    ('core-mature-foundry', '成熟與特殊製程'),
    ('core-asic', 'AI ASIC / 晶片設計'),
    ('core-network', '網通 / CPO'),
    ('core-materials', '材料 / 載板 / CCL'),
    ('core-memory', '記憶體 / HBM'),
    ('core-power', '電力 / 電源'),
    ('core-industrial', '工業電腦 / 邊緣AI'),
    ('core-gaming', '遊戲 / 授權平台'),
    ('core-highspeed-io', '高速介面 / SerDes'),
    ('core-iiiv', 'III-V 光電 / RF'),
    ('core-packaging-equip', '先進封裝設備 / 濕製程'),
    ('core-test', '高階測試介面'),
    ('core-components', '被動元件 / 連接器'),
    ('core-traditional', '傳統產業 / 自動化'),
]
...
def classify_core_bucket(core_text: str) -> str:
    ...
    mapping = [
        (('AI 散熱', '水冷', '均熱板', '熱交換器', 'CDU', '液冷'), 'core-cooling'),
        (('AI 伺服器', 'GPU', '整機整櫃', '機殼', '軸承'), 'core-ai-server'),
        (('先進製程', '先進封裝', 'CoWoS', 'OSAT', '鑽石碟', 'CIS', 'DDIC', 'IC 測試', '封測'), 'core-packaging'),
        (('成熟製程', '成熟與特殊製程', '8吋晶圓', '特殊製程'), 'core-mature-foundry'),
        (('AI ASIC', 'ASIC', '晶片設計', 'SoC', 'BMC', 'IP'), 'core-asic'),
        (('高速交換器', 'CPO', '矽光子', '網通', '低軌衛星', '800G', 'HDI'), 'core-network'),
        (('CCL', '玻纖布', 'ABF', '載板', '材料', '銅箔', 'PCB'), 'core-materials'),
        (('DRAM', 'HBM', '記憶體', 'NAND'), 'core-memory'),
        (('電力', '電源', 'HVDC', 'DrMOS', '重電'), 'core-power'),
        (('工業電腦', '邊緣 AI', '工控', '觸控 IC', 'MCU'), 'core-industrial'),
        (('遊戲', '授權平台', '高現金流', '博弈'), 'core-gaming'),
        (('高速介面', 'SerDes', 'Retimer', 'Redriver', 'DisplayPort', 'PCIe', 'USB4', '傳輸線材'), 'core-highspeed-io'),
        (('III-V', 'GaAs', '砷化鎵', 'InP', '磷化銦', 'VCSEL', 'RF 平台', '磊晶'), 'core-iiiv'),
        (('先進封裝濕製程設備', '濕製程', '電鍍', 'FOPLP', '玻璃填孔', '背面供電', '壓膜', 'AOI', '自動化設備'), 'core-packaging-equip'),
        (('高階測試介面', '探針卡', '測試板', 'KGD', 'Chiplet', 'SLT Handler', '分選機', '量測儀器', '測試座'), 'core-test'),
        (('MLCC', '被動元件', '連接器', '插槽', 'Socket', '光學鏡頭', '線束'), 'core-components'),
        (('鋼鋁', '重電', '氣動', '線性傳動', '自動化', '建廠', '潔淨室', 'SMT'), 'core-traditional'),
    ]
